...
router = APIRouter(prefix="/api/v1/as-set", tags=["as-set"])


@router.get("/expand")
async def expand_as_set(
    target: str = Query(..., description="AS-SET to expand"),
    ...
    try:
        ...
        metrics.track_request("as_set", "expand", 202)
